...
stdenv.mkDerivation {
  ...
  src = fetchFromGitHub {
    owner = "openXC7";
    repo = "nextpnr-xilinx";
    rev = "6680df93c1a0cdcb96fc8f1e01a36996671c3313";
    hash = "sha256-oFTyMRvvdnsWrLzok1TKABt6qiotEZ7FI0sXGuBXDNc=";
  ...
  meta = with lib; {
    ...
    changelog = "https://github.com/openXC7/nextpnr-xilinx/releases/tag/0.9.3";
